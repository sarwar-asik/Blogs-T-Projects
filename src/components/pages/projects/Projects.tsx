  ...
  return (
    <div className="px-[25px] my-[30px]">
      <section className="lg:flex sm:block justify-between lg:pr-[10%]  items-center">
        <div className=" my-2 pl-[10px]">
          ...
          <p className="para1 mt-3">
            {" "}
            These are my Projects those created recently and updated <br />{" "}
            adipisicing elit. Molestias eos officia dicta.
          </p>
        </div>
        <button className="bg-[#ED3833] text-white  p-2 text-light">
          {" "}
          Portfolio
        </button>
      </section>
          ...
          {projects?.map((project) => {
            ...
            "
                  ...
                  <button
                    ...
                    className=" bg-[#ed3833] px-[15px] py-[5px] my-[5px] text-white rounded-lg  hover:bg-slate-600"
                  >
                    {" "}
                    Details
                  </button>
      ...
      <footer className="flex text-center gap-3 my-12 justify-center items-center ">
        ...
        <button className="h-[38px] hover:bg-[#ED3833] hover:text-white w-[38px] text-slate-700 font-semibold bg-[#afa7a6] ">
          2
        </button>
        <button className="h-[38px] hover:bg-[#ED3833] hover:text-white w-[38px] text-slate-700 font-semibold bg-[#afa7a6] ">
          3
