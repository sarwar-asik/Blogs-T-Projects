...
const Questions = () => {
  return (
    <div className="bg-info relative  py-[120px]">
      ...
      <div className=" px-3 flex flex-col justify-start gap-2  items-center">
      <h2 className=" text-2xl ">
        {" "}
        Contact If You Have Any Projects?{" "}
      </h2>
      <p className="ml-[10%]"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae <br /> Ipsum dolor sit amet consectetur. </p>
      ...
      <img className="absolute  right-0 top-0 h-full z-20" src={rightbg} alt="" />
    </div>
  );
};
