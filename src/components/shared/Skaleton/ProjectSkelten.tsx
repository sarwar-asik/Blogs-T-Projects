      ...
      {[1, 2, 3].map((number: any) => {
        return (
          <div className="flex flex-col justify-center items-center bg-gray-300 rounded dark:bg-gray-700 relative projectBg">
            ...
            <h3 className="w-[90%] mx-auto h-[5px] shadow animate-pulse bg-slate-500 mt-3">
              {" "}
            </h3>
            <h3 className="w-[70%] mx-auto h-[5px] shadow animate-pulse bg-slate-500 mt-3">
              {" "}
            </h3>
            <h3 className="w-[50%] mx-auto h-[5px] shadow animate-pulse bg-slate-500 mt-3">
              {" "}
            </h3>
